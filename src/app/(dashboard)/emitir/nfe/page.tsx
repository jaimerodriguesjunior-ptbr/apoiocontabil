  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="page-subtitle">Escolha a operacao e revise os dados fiscais antes da transmissao.</p>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/emitir/nfe/venda" className="card group border-[#0f766e] transition-transform hover:-translate-y-0.5">
          ...
          <p className="mt-2 text-sm font-medium text-[#716b61]">Venda de mercadorias com CFOP calculado pela UF do destinatario.</p>
        ...
        <div className="card cursor-not-allowed opacity-60" aria-disabled="true">
          ...
          <h2 className="text-xl font-black text-[#25231f]">Operacao assistida</h2>
