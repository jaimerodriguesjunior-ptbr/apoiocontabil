  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="page-subtitle">Escolha a operaÃ§Ã£o e revise os dados fiscais antes da transmissÃ£o.</p>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/emitir/nfe/venda" className="card group border-[#0f766e] transition-transform hover:-translate-y-0.5">
          ...
          <p className="mt-2 text-sm font-medium text-[#716b61]">Venda de mercadorias com CFOP calculado pela UF do destinatÃ¡rio.</p>
          <span className="mt-5 inline-flex items-center gap-1 text-sm font-bold text-[#0f766e]">Continuar <ArrowRight size={16} /></span>
        </Link>
        <Link href="/emitir/nfe/assistida" className="card group transition-transform hover:-translate-y-0.5">
          <ShieldCheck size={28} className="mb-4 text-amber-700" />
          <h2 className="text-xl font-black text-[#25231f]">OperaÃ§Ã£o assistida</h2>
          <p className="mt-2 text-sm font-medium text-[#716b61]">OperaÃ§Ã£o fora do padrÃ£o, com revisÃ£o e validaÃ§Ãµes fiscais.</p>
          <span className="mt-5 inline-flex items-center gap-1 text-sm font-bold text-[#0f766e]">Continuar <ArrowRight size={16} /></span>
        </Link>
      </div>
    </div>
