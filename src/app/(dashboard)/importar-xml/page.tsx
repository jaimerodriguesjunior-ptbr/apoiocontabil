...
export default async function ImportarXmlPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        <h1 className="page-title flex items-center gap-2"><FileUp size={24} /> Importar XML</h1>
        <p className="page-subtitle">Importe NF-e de entrada para consultar os itens e emitir devolṳ̵es.</p>
      </div>
      <ImportarXmlForm />
    </div>
  );
